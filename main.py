...
# MADE BY KAIF TARASAGAR
        ...
        self.search_entry = tk.Entry(self.search_frame, textvariable=self.search_var, width=40, font=("Arial", 12), bg="white", fg="black", insertbackground="black")
...
# MADE BY KAIF TARASAGAR
    ...
    def update_tree_styles(self):
        if self.dark_mode:
            self.tree.tag_configure("high", background="#e45252", foreground="black")
