...
# MADE BY KAIF TARASAGAR
        ...
        self.search_entry = tk.Entry(self.search_frame, textvariable=self.search_var, width=40, font=("Arial", 12), insertbackground="black")
...
# MADE BY KAIF TARASAGAR
    ...
    def toggle_dark_mode(self):
        ...
        if self.dark_mode:
            ...
            self.search_entry.config(bg="#2d3238", fg="white", insertbackground="white")
