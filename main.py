...
# MADE BY KAIF TARASAGAR
    ...
    def update_tree_styles(self):
        if self.dark_mode:
            # Dark mode: de-emphasized color for completed tasks with WCAG AA compliance (foreground #a9a9a9, background #212529)
            self.tree.tag_configure("done", foreground="#a9a9a9", background="#212529")
        else:
            # Light mode: de-emphasized color for completed tasks with WCAG AA compliance (foreground #595959, background #f8f9fa)
        ...
        self.tree.tag_configure("medium", background="#ebc139", foreground="white" if self.dark_mode else "black")
        self.tree.tag_configure("low", background="#23e24f", foreground="white" if self.dark_mode else "black")
    def add_task(self):
