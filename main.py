...
# MADE BY KAIF TARASAGAR
    ...
    def update_tree_styles(self):
        # Configure the core priority tags
        ...
        # Configure the 'done' tag based on the active dark_mode state
        # Foreground #595959 on background #f8f9fa in light mode (~6.6:1 contrast)
        # Foreground #a9a9a9 on background #212529 in dark mode (~6.4:1 contrast)
        if self.dark_mode:
...
# MADE BY KAIF TARASAGAR
    ...
    def toggle_dark_mode(self):
        ...
        if self.dark_mode:
            ...
            self.search_entry.config(bg="#212529", fg="white", insertbackground="white")
