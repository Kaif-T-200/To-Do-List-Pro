...
# MADE BY KAIF TARASAGAR
        ...
        self.search_label = tk.Label(self.search_frame, text="🔍 Search:", font=("Arial", 12), bg="#f8f9fa", fg="#212529")
        self.search_label.pack(side=tk.LEFT, padx=5)

        self.search_var = tk.StringVar()# MADE BY KAIF TARASAGAR
        self.search_var.trace("w", lambda *args: self.refresh_list())

        self.search_entry = tk.Entry(self.search_frame, textvariable=self.search_var, width=40, font=("Arial", 12), bg="white", fg="#212529", insertbackground="black")
...
# MADE BY KAIF TARASAGAR
    ...
    def toggle_dark_mode(self):
        ...
        if self.dark_mode:
            ...
            self.search_entry.config(bg="white", fg="#212529", insertbackground="black")
