...
# MADE BY KAIF TARASAGAR
        ...
        self.dark_btn = tk.Button(self.btn_frame, text="🌙 Toggle Dark Mode", width=18, command=self.toggle_dark_mode, bg="#343a40", fg="white")
        self.dark_btn.grid(row=0, column=5, padx=6)
# MADE BY KAIF TARASAGAR
...
# MADE BY KAIF TARASAGAR
    ...
    def update_tree_styles(self):
        # Update configurations for Treeview tags to guarantee WCAG AA accessibility
        if self.dark_mode:
